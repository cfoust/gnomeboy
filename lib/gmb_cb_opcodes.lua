...
function mt:RotateLeftCarry(R1)
	local Bit7 = bit.band(R1,128) == 128
	
	R1 = bit.bor(bit.band((bit.lshift(R1,1)),0xFE),(Bit7 and 1 or 0))
	self.Cf = Bit7
	self.Zf = R1 == 0
	self.Nf = false
	self.Hf = false
...
function mt:RotateRightCarry(R1)
	local Bit0 = bit.band(R1,1) == 1
	
	R1 = bit.bor(bit.band(bit.rshift(R1,1),0xFF),(Bit0 and 128 or 0))
...
function mt:RotateLeft(R1)
	...
	R1 = bit.bor(bit.band((bit.lshift(R1,1)),0xFE),(self.Cf and 1 or 0))
...
function mt:RotateRight(R1)
	...
	R1 = bit.bor(bit.band(bit.rshift(R1,1),0xFF),(self.Cf and 128 or 0))
...
function mt:ArithmaticShiftLeft(R1)
	...
	R1 = bit.band((bit.lshift(R1,1)),0xFE) --- 0xFE for a reason, this is arithmatic shift.
...
function mt:ArithmaticShiftRight(R1)
	...
	R1 = bit.bor(bit.band(bit.rshift(R1,1),0xFF ),(Bit7 and 128 or 0))
...
function mt:ShiftRight(R1)
	...
	R1 = bit.band(bit.rshift(R1,1),0xFF)
...
function mt:Swap(R1)
	...
	R1 = bit.bor(bit.rshift(bit.band(R1,0xF0),4),bit.lshift(bit.band(R1,0x0F),4)) 
...
OperatorsCB[ 0x06 ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:RotateLeftCarry( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x0E ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:RotateRightCarry( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x16 ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:RotateLeft( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x1E ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:RotateRight( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x26 ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:ArithmaticShiftLeft( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x2E ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:ArithmaticShiftRight( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x36 ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:Swap( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x3E ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:ShiftRight( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x46 ] = function( self ) self:TstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,0 ); self.Cycle = 16 end
...
OperatorsCB[ 0x4E ] = function( self ) self:TstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,1 ); self.Cycle = 16 end
...
OperatorsCB[ 0x56 ] = function( self ) self:TstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,2 ); self.Cycle = 16 end
...
OperatorsCB[ 0x5E ] = function( self ) self:TstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,3 ); self.Cycle = 16 end
...
OperatorsCB[ 0x66 ] = function( self ) self:TstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,4 ); self.Cycle = 16 end
...
OperatorsCB[ 0x6E ] = function( self ) self:TstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,5 ); self.Cycle = 16 end
...
OperatorsCB[ 0x76 ] = function( self ) self:TstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,6 ); self.Cycle = 16 end
...
OperatorsCB[ 0x7E ] = function( self ) self:TstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,7 ); self.Cycle = 16 end
...
OperatorsCB[ 0x86 ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:RstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L))  ,0 )); self.Cycle = 16 end
...
OperatorsCB[ 0x8E ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:RstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,1 )); self.Cycle = 16 end
...
OperatorsCB[ 0x96 ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:RstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,2 )); self.Cycle = 16 end
...
OperatorsCB[ 0x9E ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:RstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,3 )); self.Cycle = 16 end
...
OperatorsCB[ 0xA6 ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:RstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,4 )); self.Cycle = 16 end
...
OperatorsCB[ 0xAE ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:RstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,5 )); self.Cycle = 16 end
...
OperatorsCB[ 0xB6 ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:RstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,6 )); self.Cycle = 16 end
...
OperatorsCB[ 0xBE ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:RstBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,7 )); self.Cycle = 16 end
...
OperatorsCB[ 0xC6 ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:SetBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,0 )); self.Cycle = 16 end
...
OperatorsCB[ 0xCE ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:SetBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,1 )); self.Cycle = 16 end
...
OperatorsCB[ 0xD6 ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:SetBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,2 )); self.Cycle = 16 end
...
OperatorsCB[ 0xDE ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:SetBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,3 )); self.Cycle = 16 end
...
OperatorsCB[ 0xE6 ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:SetBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,4 )); self.Cycle = 16 end
...
OperatorsCB[ 0xEE ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:SetBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,5 )); self.Cycle = 16 end
...
OperatorsCB[ 0xF6 ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:SetBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,6 )); self.Cycle = 16 end
...
OperatorsCB[ 0xFE ] = function( self ) self:Write(bit.bor(bit.lshift(self.H,8),self.L), self:SetBit( self:Read(bit.bor(bit.lshift(self.H,8),self.L)) ,7 )); self.Cycle = 16 end
